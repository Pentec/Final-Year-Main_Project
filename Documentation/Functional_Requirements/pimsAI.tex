...
\begin{description}
	...
	\begin{description}
		...
		\begin{figure}[H]
			\centerline{\includegraphics[width=0.8\linewidth]{./Graphics/pimsAI/pimsGetSurvivalRate_ServiceContract}}
	...
	\begin{description}
		\item{\textbf{Service Contract}} The generic service contract
		\begin{figure}[H]
			\centerline{\includegraphics[width=0.9\linewidth]{./Graphics/pimsAI/getPatientChanceOfSurvival_ProcessSpecification}}
