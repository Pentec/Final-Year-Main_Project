...
\begin{description}
	...
	\begin{description}
		...
		\begin{figure}[H]
			\centerline{\includegraphics[width=0.7\linewidth]{./Graphics/pimsStats/pimscreateGraph_ServiceContract}}
	...
	\end{description}
		...
		\begin{figure}[H]
			\centerline{\includegraphics[width=0.7\linewidth]{./Graphics/pimsStats/viewStats_ProcessSpecification}}
