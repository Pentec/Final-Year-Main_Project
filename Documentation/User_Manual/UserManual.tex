...
\begin{itemize}
	\item Figure 1
	\begin{figure}[H]
        \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Graphics/Troubleshooting/figure1}}}
		\caption{Recapture error}
      \end{figure}
	\item Figure 2
	\begin{figure}[H]
        \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Graphics/Troubleshooting/figure2}}}
		\caption{Adding a user error}
      \end{figure}
	
	\item Figure 3
	\begin{figure}[H]
        \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Graphics/Troubleshooting/figure3}}}
		\caption{Inactive query button error}
      \end{figure}
      \item Figure 4
	\begin{figure}[H]
        \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Graphics/Troubleshooting/figure4}}}
		\caption{Remove user error}
      \end{figure}
	
	\item Figure 5
	\begin{figure}[H]
        \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Graphics/Troubleshooting/figure5}}}
