...
var saveAdmissionDischarge = function(formData, usersname) {
    ...
    var Form = new AD({
        ...
        isNotCompeleted: changedString.isNotCompeleted,
        completedBy: usersname
    });
...
var saveGynaecologySurgery = function(formData, usersname) {
    var jsonString = JSON.stringify(formData.body);
    var changedString = jsonString.replace(/([./])/g, "");
...
var saveCervicalCancer = function(formData, usersname) {
    var jsonString = JSON.stringify(formData.body);
    var changedString = jsonString.replace(/([./])/g, "");
...
module.exports = {
    saveGynaecologySurgery: saveGynaecologySurgery,
    saveAdmissionDischarge: saveAdmissionDischarge,
    submitCervicalCancer: saveCervicalCancer
};